      ...
      <div className="border-b border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-900">
        <div className="flex items-center space-x-3">
          {conversation.other_user?.profile_image ? (
            ...
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-300 dark:bg-gray-200">
              <User size={16} className="text-gray-600 dark:text-gray-500" />
            </div>
          )}
          <div>
      ...
      <div className="border-t border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
        ...
        <form onSubmit={handleSendMessage} className="flex space-x-2">
          <input
            ...
            className="flex-1 rounded-lg border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-200 dark:focus:ring-blue-500 sm:text-sm"
          />
          <button
            type="submit"
